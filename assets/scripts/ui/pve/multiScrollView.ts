import { _decorator, Component, ScrollView, Prefab, NodePool, instantiate, Size, Vec2, view, UITransform, find, Vec3, Node, screen } from 'cc';
...
export class MultiScrollView extends Component {
    ...
    createCloud () {
        this.positionCloud1 = [];
        this.positionCloud2 = [];
        var winHeight = screen.windowSize.height;
